...
app.get('/api/movies', loggerMiddleware, timeMiddleware, tokenMiddleware, getMoviesApi)
app.get('/api/movies/:id',loggerMiddleware, checkMovieIdMiddleware, getMoviesbyIdApi)
